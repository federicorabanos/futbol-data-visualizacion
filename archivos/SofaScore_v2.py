...
class SofaScore:
    ...
    def translate_fields(self):
        traduccion = {
            ...
            'errorLeadToGoal': 'Error que deriva en gol',
            'errorLeadToShot': 'Error que deriva en tiro',
            'passToAssist': 'Pases para asistencia'
            }
        return traduccion
    ...
    def scrape_league_stats(self, tournament, season, accumulation='total', selected_positions=['Goalkeepers', 'Defenders', 'Midfielders', 'Forwards']):
        ...
        for i in range(0,100):
            url = f'https://api.sofascore.com/api/v1/unique-tournament/{tournaments_ids[tournament]}/season/{season_ids[season]}/statistics?limit=100&order=-rating&offset={offset}&accumulation={accumulation}&fields={fields}&filters=position.in.{positions}'
